...
public class InitClient {
	...
	public static void init() {
		...
		REGISTRY_CLIENT.registerBlockRenderType(RenderLayer.getCutout(), Blocks.PLATFORM_LIGHT_GREEN_QUARTZ_BLOCK);
		REGISTRY_CLIENT.registerBlockRenderType(RenderLayer.getCutout(), Blocks.PLATFORM_LIGHT_GREEN_QUARTZ_BLOCK_INDENTED);
		REGISTRY_CLIENT.registerBlockRenderType(RenderLayer.getCutout(), Blocks.PLATFORM_LIGHT_GREEN_QUARTZ_BLOCK_SLAB);
		REGISTRY_CLIENT.registerBlockRenderType(RenderLayer.getCutout(), Blocks.PLATFORM_LIGHT_GREEN_SMOOTH_QUARTZ);
		REGISTRY_CLIENT.registerBlockRenderType(RenderLayer.getCutout(), Blocks.PLATFORM_LIGHT_GREEN_SMOOTH_QUARTZ_INDENTED);
		REGISTRY_CLIENT.registerBlockRenderType(RenderLayer.getCutout(), Blocks.PLATFORM_LIGHT_GREEN_SMOOTH_QUARTZ_SLAB);
		...
		REGISTRY_CLIENT.registerBlockRenderType(RenderLayer.getTranslucent(), Blocks.GATE_HK_C762);
		REGISTRY_CLIENT.registerBlockRenderType(RenderLayer.getTranslucent(), Blocks.GATE_HK_C762_EXIT);
